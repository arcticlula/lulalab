import{j as X,a8 as Z,bC as ee,m as a,t as s,n as _,d as x,z as O,B as w,bD as te,A as ie,g as R,G as M,h as n,U as k,q as z,c as ne,F as re,r as V,x as L,bi as oe,i as ae,ai as C,ba as le,a5 as E,R as I,L as v,T as m,P as f,am as $,M as g,a2 as ce,K as y,bE as se,V as F,$ as B,a3 as S,bF as de,Y as D,a0 as me,a1 as he,a6 as ue,bq as ge}from"./index-C9V2a9_4.js";import{_ as pe,a as _e}from"./Grid-pPTOqif_.js";import"./next-frame-once-C5Ksf8W7.js";let W=!1;function fe(){if(X&&window.CSS&&!W&&(W=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function ve(e){const{textColor3:t,infoColor:i,errorColor:c,successColor:r,warningColor:h,textColor1:u,textColor2:l,railColor:d,fontWeightStrong:p,fontSize:o}=e;return Object.assign(Object.assign({},ee),{contentFontSize:o,titleFontWeight:p,circleBorder:`2px solid ${t}`,circleBorderInfo:`2px solid ${i}`,circleBorderError:`2px solid ${c}`,circleBorderSuccess:`2px solid ${r}`,circleBorderWarning:`2px solid ${h}`,iconColor:t,iconColorInfo:i,iconColorError:c,iconColorSuccess:r,iconColorWarning:h,titleTextColor:u,contentTextColor:l,metaTextColor:t,lineColor:d})}const xe={common:Z,self:ve},be=a("thing",`
 display: flex;

import{A as Q,bF as X,G as l,H as c,J as v,d as b,T as R,U as T,bG as ee,V as te,e as P,Z as W,h as o,F as $,I as z,a6 as ie,af as ne,r as j,O as L,b7 as oe,a7 as re,Y as C,aZ as ae,x as k,i as H,o as h,k as m,f as x,a2 as S,a as _,v as le,c as f,bH as se,l as w,g as F,m as B,t as E,bI as ce,u as N,n as de,q as me,y as ue,bf as he}from"./index-Di5EsIde.js";import{_ as ge,a as pe}from"./Grid-CXyvg8g8.js";import{u as fe}from"./use-houdini-BqWYFtO6.js";import"./next-frame-once-C5Ksf8W7.js";function _e(e){const{textColor3:t,infoColor:i,errorColor:s,successColor:r,warningColor:u,textColor1:p,textColor2:a,railColor:d,fontWeightStrong:g,fontSize:n}=e;return Object.assign(Object.assign({},X),{contentFontSize:n,titleFontWeight:g,circleBorder:`2px solid ${t}`,circleBorderInfo:`2px solid ${i}`,circleBorderError:`2px solid ${s}`,circleBorderSuccess:`2px solid ${r}`,circleBorderWarning:`2px solid ${u}`,iconColor:t,iconColorInfo:i,iconColorError:s,iconColorSuccess:r,iconColorWarning:u,titleTextColor:p,contentTextColor:a,metaTextColor:t,lineColor:d})}const ve={common:Q,self:_e},xe=l("thing",`
 display: flex;
...
`,[z("horizontal",`
 ...
 `)])])]),Ce=Object.assign(Object.assign({},T.props),{horizontal:Boolean,itemPlacement:{type:String,default:"left"},size:{type:String,default:"medium"},iconSize:Number}),D=ie("n-timeline"),$e=b({name:"Timeline",props:Ce,setup(e,{slots:t}){const{mergedClsPrefixRef:i}=R(e),s=T("Timeline","-timeline",ze,ve,e,i);return ne(D,{props:e,mergedThemeRef:s,mergedClsPrefixRef:i}),()=>{const{value:r}=i;return o("div",{class:[`${r}-timeline`,e.horizontal&&`${r}-timeline--horizontal`,`${r}-timeline--${e.size}-size`,!e.horizontal&&`${r}-timeline--${e.itemPlacement}-placement`]},t)}}}),Se={time:[String,Number],title:String,content:String,color:String,lineType:{type:String,default:"default"},type:{type:String,default:"default"}},we=b({name:"TimelineItem",props:Se,slots:Object,setup(e){const t=re(D);t||oe("timeline-item","`n-timeline-item` must be placed inside `n-timeline`."),fe();const{inlineThemeDisabled:i}=R(),s=P(()=>{const{props:{size:u,iconSize:p},mergedThemeRef:a}=t,{type:d}=e,{self:{titleTextColor:g,contentTextColor:n,metaTextColor:y,lineColor:I,titleFontWeight:O,contentFontSize:J,[C("iconSize",u)]:K,[C("titleMargin",u)]:q,[C("titleFontSize",u)]:G,[C("circleBorder",d)]:U,[C("iconColor",d)]:Y},common:{cubicBezierEaseInOut:Z}}=a.value;return{"--n-bezier":Z,"--n-circle-border":U,"--n-icon-color":Y,"--n-content-font-size":J,"--n-content-text-color":n,"--n-line-color":I,"--n-meta-text-color":y,"--n-title-font-size":G,"--n-title-font-weight":O,"--n-title-margin":q,"--n-title-text-color":g,"--n-icon-size":ae(p)||K}}),r=i?W("timeline-item",P(()=>{const{props:{size:u,iconSize:p}}=t,{type:a}=e;return`${u[0]}${p||"a"}${a[0]}`}),s,t.props):void 0;return{mergedClsPrefix:t.mergedClsPrefixRef,cssVars:i?void 0:s,themeClass:r==null?void 0:r.themeClass,onRender:r==null?void 0:r.onRender}},render(){const{mergedClsPrefix:e,color:t,onRender:i,$slots:s}=this;return i==null||i(),o("div",{class:[`${e}-timeline-item`,this.themeClass,`${e}-timeline-item--${this.type}-type`,`${e}-timeline-item--${this.lineType}-line-type`],style:this.cssVars},o("div",{class:`${e}-timeline-item-timeline`},o("div",{class:`${e}-timeline-item-timeline__line`}),j(s.icon,r=>r?o("div",{class:`${e}-timeline-item-timeline__icon`,style:{color:t}},r):o("div",{class:`${e}-timeline-item-timeline__circle`,style:{borderColor:t}}))),o("div",{class:`${e}-timeline-item-content`},j(s.header,r=>r||this.title?o("div",{class:`${e}-timeline-item-content__title`},r||this.title):null),o("div",{class:`${e}-timeline-item-content__content`},L(s.default,()=>[this.content])),o("div",{class:`${e}-timeline-item-content__meta`},L(s.footer,()=>[this.time]))))}}),Ee={};function Te(e,t){const i=ye,s=le;return h(),H(s,null,{default:m(()=>[x(i,null,{header:m(()=>[S(e.$slots,"header")]),"header-extra":m(()=>[_("b",null,[S(e.$slots,"headerExtra")])]),description:m(()=>[S(e.$slots,"description")]),footer:m(()=>[S(e.$slots,"footer")]),_:3})]),_:3})}const ke=k(Ee,[["render",Te]]),A=[{title:"Full-Stack Developer",time:"August 2020 - October 2025",subtitle:"Fujifilm",description:"Web development - <i>full-stack</i> - across internal tools and client-facing products in the medical field.",details:["Internal management app for overseeing and maintaining photo kiosks.","Design framework to standardize and speed up development across multiple Fujifilm projects.","<i>SYNAPSE Clinical Workflow Manager (CWM 5)</i> - involved from the inception of the latest version, contributing extensively to its development and feature implementation using a <i>microservices</i> architecture on both frontend and backend."],type:"Experience"},{title:"Software Engineer",time:"November 2017 - July 2020",subtitle:"Dotlogic - IT Solutions",description:"Architecture and development of web applications in the medical field, mostly <i>cardiology</i>. Responsible for frontend, backend and database design, with some <i>hardware</i> work along the way.",details:["Web apps for medical staff to report and manage patient exam data, tailored for cardiology and gastroenterology departments.","Signal viewer for analyzing long-duration heart monitor waveforms (e.g. 24-hour Holter data), including integration with the acquisition hardware.","Mobile web app that talks to a blood pressure monitor over <i>Bluetooth</i>, enabling real-time data capture, patient monitoring and automatic reporting back to the hospital system."],type:"Experience"},{title:"Make Or Break",time:"September 8-12, 2017",subtitle:"48 Hour Hackathon",description:"Part of the winning team of the 2017 edition of <i>Make Or Break</i> in the <i>funny</i> category. Built a web app to rate public restrooms in two days - plus a remote controlled toilet paper dispenser to go with it.",type:"Other"},{title:"Volunteer Tutor",time:"September 2016 - 2019",subtitle:"Já T'Explico",description:"Tutoring support for children and teenagers from 5th to 9th grade in the Porto district.",type:"Other"},{title:"ISEP - Porto School of Engineering",time:"2015 - 2018",subtitle:"Master's in Electrical and Computer Engineering",description:"Thesis: development of a <i>LED wall that responds to violin notes</i>, displaying dynamic patterns. Tested live in two small concerts.",type:"Education"},{title:"ISEP - Porto School of Engineering",time:"September 2012 - August 2015",subtitle:"Bachelor's in Electrical Engineering",description:"Thesis: <i>PID control of a drone's camera gimbal system</i>.",type:"Education"},{title:"Advanced Electronics Course - 175 Hours",time:"July 2013 - December 2013",subtitle:"ATEC",description:"Training in advanced electronic systems.<br/>Edf. Siemens, Av. Mário Brito (EN 107) 3570 - Freixieiro 4455-491 Perafita",type:"Education"}],M=e=>(de("data-v-caa36bf4"),e=e(),me(),e),Ie={class:"about"},Oe=M(()=>_("h1",{class:"pink-text"},"Education",-1)),Pe=M(()=>_("h1",{class:"blue-text"},"Other",-1)),Be=M(()=>_("h1",{class:"white-text"},"Experience",-1)),Re=["innerHTML"],He=["innerHTML"],Me={key:0,class:"details"},je=["innerHTML"],Le=b({__name:"CV",setup(e){function t(i){return i==="Education"?"card-left":i==="Experience"?"card-right":"card-center"}return(i,s)=>{const r=se,u=pe,p=ge;return h(),f("div",Ie,[x(r,{justify:"space-between"},{default:m(()=>[Oe,Pe,Be]),_:1}),x(p,{"y-gap":"16",cols:1},{default:m(()=>[(h(!0),f($,null,w(N(A),(a,d)=>(h(),H(u,{key:d,class:ce(["cv-entry",t(a.type)])},{default:m(()=>[x(ke,null,{header:m(()=>[_("span",{innerHTML:a.title},null,8,Re)]),headerExtra:m(()=>[B(E(a.time),1)]),description:m(()=>[B(E(a.subtitle),1)]),footer:m(()=>[_("span",{innerHTML:a.description},null,8,He),a.details?(h(),f("ul",Me,[(h(!0),f($,null,w(a.details,(g,n)=>(h(),f("li",{key:n,innerHTML:g},null,8,je))),128))])):F("",!0)]),_:2},1024)]),_:2},1032,["class"]))),128))]),_:1})])}}}),Ve=k(Le,[["__scopeId","data-v-caa36bf4"]]),We={class:"cv-container"},Fe={class:"timeline-wrapper"},Ne={class:"timeline-content"},De={key:0,class:"details"},Ae=["innerHTML"],Je="rgb(255,198,194)",Ke="rgb(250,233,218)",qe="rgb(195,224,221)",Ge=b({__name:"CVResponsive",setup(e){function t(i){return i==="Education"?Je:i==="Experience"?Ke:qe}return(i,s)=>{const r=ue,u=we,p=$e;return h(),f("div",We,[_("div",Fe,[x(p,{size:"large"},{default:m(()=>[(h(!0),f($,null,w(N(A),(a,d)=>(h(),H(u,{key:d,color:t(a.type),time:a.time},{header:m(()=>[_("span",{style:he({color:t(a.type),fontWeight:"bold",fontSize:"1rem"})},E(a.title),5)]),default:m(()=>[_("div",Ne,[x(r,{style:{margin:"0 0 8px 0","font-weight":"bold","font-size":"0.9rem",color:"#e2e2e2"}},{default:m(()=>[B(E(a.subtitle),1)]),_:2},1024),x(r,{style:{margin:"0",opacity:"0.8","line-height":"1.5","font-size":"0.7rem"},innerHTML:a.description},null,8,["innerHTML"]),a.details?(h(),f("ul",De,[(h(!0),f($,null,w(a.details,(g,n)=>(h(),f("li",{key:n,innerHTML:g},null,8,Ae))),128))])):F("",!0)])]),_:2},1032,["color","time"]))),128))]),_:1})])])}}}),Ue=k(Ge,[["__scopeId","data-v-e3049b82"]]),Ye={class:"cv-wrapper"},Ze={class:"cv-desktop"},Qe={class:"cv-mobile"},Xe=b({__name:"CVWrapper",setup(e){return(t,i)=>(h(),f("div",Ye,[_("div",Ze,[x(Ve)]),_("div",Qe,[x(Ue)])]))}}),ot=k(Xe,[["__scopeId","data-v-e6455dc2"]]);export{ot as default};

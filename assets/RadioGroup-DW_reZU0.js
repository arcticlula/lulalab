...
`,[R("splitor",`
 ...
 `),$("checked",{color:"var(--n-button-text-color-hover)"})]),S("focus",[I("&:not(:active)",[R("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),S("checked",`
